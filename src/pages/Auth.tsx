    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="h-12 w-12 rounded-xl bg-primary flex items-center justify-center text-primary-foreground text-xl font-bold mx-auto mb-4" style={{ fontFamily: 'Space Grotesk' }}>
            B
          </div>
          <h1 className="text-2xl font-bold" style={{ fontFamily: 'Space Grotesk' }}>Welcome to BCR</h1>
          <p className="text-muted-foreground mt-1">Stream, Share, Connect</p>
        </div>
